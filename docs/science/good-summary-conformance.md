...
| Language & Style | No acronyms/abbreviations | Must | Not assessed — requires regulatory/legal judgment (see §8) | **Yes** | `_style_rules.txt`: "Expand every abbreviation." Abbreviation list also fed into grounding to aid extraction from dense source text | Read `backend/care_plan/prompts/_style_rules.txt`; PRD 03 §3.3 |
